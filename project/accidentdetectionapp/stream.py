...
def sendmail():
    ...
    gmail_list.append("ktmadhankumar2003@gmail.com")
...
class streaming(object):
    def __init__(self):
        ...
        self.model1=torch.hub.load('ultralytics/yolov5', 'custom', path=r'D:\1. Accident Detection AI Methods Using Django frame work\best (2).pt',device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path=r'D:\1. Accident Detection AI Methods Using Django frame work\accident2.pt',device='cpu')
